...
export default function AgregarPapeletaForm({
  ...
  const handleSubmit = async (e) => {
    ...
    await axios.post("http://localhost:3000/papeletas", payload);
    setColor("");
    setNumero("");
    setCiCandidato("");
    setIdPartido("");
