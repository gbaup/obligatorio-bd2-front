    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", justifyContent: "flex-end" }}>
          <button
            onClick={onCancel}
            style={{ marginRight: 12, background: "#eee", color: "#213547" }}
          >
            Cancelar
          </button>
...
export default function MiembroMesaPanel({ user }) {
  ...
  return (
    <div className="centered">
      <div
        className="card"
        style={{ width: 500, maxWidth: "98vw", textAlign: "center" }}
      >
        <Header />
        ...
        {circuito && (
          <section style={{ marginBottom: 20 }}>
            ...
            <div style={{ fontSize: 15 }}>
              ...
              <b>Votos aceptados:</b> {votosTotales - votosObservadosCount}{" "}
              <br />
        ...
        <div style={{ marginBottom: 16 }}>
          <b>Bienvenido{user ? `, ${user.nombres} ${user.apellidos}` : ""}.</b>
        ...
        {mesa ? (
          <section>
            ...
            >
              <h4 style={{ marginBottom: 8, color: "#2d5be3" }}>
                Votos Observados
              </h4>
              {loadingVotos ? (
